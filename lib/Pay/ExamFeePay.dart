...
class ExamFeePay extends StatefulWidget {
  ...
  const ExamFeePay({super.key, required this.StudentDueAmount, required this.StudentEmail, required this.StudentName, required this.StudentPhoneNumber, required this.FatherPhoneNo});
...
class _ExamFeePayState extends State<ExamFeePay> {
  ...
  Future StudentExamFeePayFunction(PaymentID, moneyReceiverEmail, moneyReceiverName) async{
    ...
    setState(() {
      loading = true;
          ...
          final docUser =  FirebaseFirestore.instance.collection("ExamFeePayPayHistory");
                      ...
                      final jsonData ={
                        ...
                        "FeeName":FeeNameController.text.trim()
        ...
        color: myFocusNode.hasFocus ? Color.fromRGBO(92, 107, 192, 1): Colors.black
              ...
              Row(
                ...
                FirebaseAuth.instance
                  ...
                  StudentExamFeePayFunction(PaymentID, user.email, user.displayName);
