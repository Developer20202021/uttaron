...
class AdminImageUpload extends StatefulWidget {
  ...
  const AdminImageUpload({super.key,  required this.AdminEmail,});
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Admin").doc(widget.AdminEmail);
                  ...
                  final UpadateData ={
                    ...
                    "AdminNIDFrontImageUrl":AdminNIDFrontImageUrl
                ...
                // );
                   ...
                   print("______________________________________________________________________________${totalImageCount}");
                    ...
                    backgroundColor: Colors.transparent,
                    content: AwesomeSnackbarContent(
                      title: 'NID Front Image Upload Successfull',
                      message:
                          'NID Front Image Upload Successfull',
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Admin").doc(widget.AdminEmail);
                  ...
                  final UpadateData ={
                    ...
                    "AdminNIDBackImageUrl":AdminNIDBackImageUrl
      ...
      body: SingleChildScrollView(
        ...
        Container(
          ...
          SizedBox(height: 75,),
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("নিচে আপনার NID Front Image Upload করুন", style: TextStyle(color: Colors.black),),
            )),
          ...
          SizedBox(height: 75,),
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("নিচে আপনার NID Back Image Upload করুন", style: TextStyle(color: Colors.black),),
            )),
