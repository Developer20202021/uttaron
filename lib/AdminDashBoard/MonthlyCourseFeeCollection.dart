...
class MonthlyCourseFeeCollection extends StatefulWidget {
  ...
  @override
  State<MonthlyCourseFeeCollection> createState() => _MonthlyCourseFeeCollectionState();
}

class _MonthlyCourseFeeCollectionState extends State<MonthlyCourseFeeCollection> {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text("${VisiblePaymentMonth} মাসে ${moneyAdd}৳ Course Fee গ্রহন করেছেন।", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),overflow: TextOverflow.ellipsis,),
            ),),
