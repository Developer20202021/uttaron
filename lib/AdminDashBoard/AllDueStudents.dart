...
Future<void> getData() async {
  ...
  // all Due Query Count
     Query _CustomerOrderHistoryCollectionRefDueQueryCount = _CustomerOrderHistoryCollectionRef.where("StudentType", isEqualTo: "Due").where("StudentStatus", isEqualTo: "new");
